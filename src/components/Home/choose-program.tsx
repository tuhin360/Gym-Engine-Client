...
export function ChooseProgram() {
  return (
    <section className="py-24 bg-white text-black" id="programs">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
          {programs.map((program, index) => (
            <div key={index} className="flex flex-col sm:flex-row gap-6 items-center sm:items-start group">
              <div className="flex-shrink-0 w-24 h-24 flex items-center justify-center bg-gray-100 rounded-full group-hover:bg-orange-500 transition-colors duration-300">
                <Image 
                  src={program.icon} 
                  width={48} 
                  height={48} 
              ...
              <div className="flex flex-col text-center sm:text-left pt-2">
                ...
                <p className="text-gray-500 mb-4 leading-relaxed">{program.subtitle}</p>
                <Link 
                  href="#" 
