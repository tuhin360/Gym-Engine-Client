...
export function ContactHero() {
  return (
    <section className="relative py-32 md:py-48 bg-slate-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,_rgba(220,38,38,0.3),_transparent_70%)] z-10" />
      ...
      <div className="container relative z-20 mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl text-zinc-300 max-w-2xl mx-auto font-medium">
          Have questions about membership or classes? Reach out to our team and we'll help you find the best path for your fitness journey.
        </p>
      </div>
    </section>
  );
