  ...
  return (
    <section className="relative py-32 md:py-48 bg-slate-900 flex items-center justify-center overflow-hidden">
      <div 
        ...
        style={{ backgroundImage: "url('/assets/training-image-01.jpg')" }}
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black via-transparent to-black z-10" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(220,38,38,0.3),_transparent_70%)] z-10" />
